...
export const translations: Translations = {
  ...
  'dashboard.withinRange': { id: 'Dalam target', en: 'Within target' },
  'dashboard.belowRange': { id: 'di bawah target', en: 'below target' },
  'dashboard.aboveRange': { id: 'di atas target', en: 'above target' },
  'dashboard.target': { id: 'Target', en: 'Target' },
  ...
  'dashboard.superfoodPlaceholder': { id: 'Nama superfood', en: 'Superfood name' },
  ...
  'dashboard.noSuperfoods': { id: 'Belum ada superfood. Ketuk Tambah untuk membuat!', en: 'No superfoods yet. Tap Add to create one!' },
  ...
  'profile.display': { id: 'Tampilan', en: 'Display' },
  ...
  'profile.to': { id: 'sampai', en: 'to' },
  'profile.calOfTdee': { id: 'kal dari TDEE', en: 'cal of TDEE' },
  'profile.rangeError': { id: 'Min harus ≤ maks', en: 'Min must be ≤ max' },
  ...
  'friends.sharedHabits': { id: 'Undangan Kebiasaan', en: 'Habit Invitations' },
  'friends.sharedHabitInvite': { id: '{name} mengajak kamu untuk berbagi kebiasaan', en: '{name} wants to share a habit with you' },
  'friends.noSharedInvites': { id: 'Tidak ada undangan kebiasaan', en: 'No habit invitations' },
  'friends.shareHabit': { id: 'Bagikan ke Teman', en: 'Share with Friend' },
  'friends.selectFriend': { id: 'Pilih teman', en: 'Select a friend' },
  'friends.habitShared': { id: 'Kebiasaan dibagikan!', en: 'Habit shared!' },
  'friends.failedShare': { id: 'Gagal membagikan kebiasaan', en: 'Failed to share habit' },
  'friends.sharedAccepted': { id: 'Undangan diterima!', en: 'Invitation accepted!' },
  'friends.failedAcceptShared': { id: 'Gagal menerima undangan', en: 'Failed to accept invitation' },
  'friends.failedRejectShared': { id: 'Gagal menolak undangan', en: 'Failed to reject invitation' },
  'friends.feedAll': { id: 'Semua', en: 'All' },
  'friends.feedMine': { id: 'Aktivitas Saya', en: 'My Activity' },
  'friends.feedFriends': { id: 'Teman', en: 'Friends' },
  'friends.loadMore': { id: 'Muat Lebih Banyak', en: 'Load More' },
  'friends.noFeedYet': { id: 'Belum ada aktivitas. Tambah teman dan mulai lacak kebiasaan bersama!', en: 'No activity yet. Add friends and start tracking habits together!' },
  'friends.completed': { id: 'menyelesaikan', en: 'completed' },
  'friends.hitStreak': { id: 'mencapai streak', en: 'hit a' },
  'friends.dayStreak': { id: 'hari streak pada', en: 'day streak on' },
  'friends.nowFriends': { id: 'sekarang berteman', en: 'are now friends' },
  'friends.sharedStreak': { id: 'sedang streak bersama', en: 'are on a streak together on' },
  'friends.ago': { id: 'lalu', en: 'ago' },
  'friends.justNow': { id: 'Baru saja', en: 'Just now' },
  'friends.minutesAgo': { id: 'mnt lalu', en: 'min ago' },
  'friends.hoursAgo': { id: 'jam lalu', en: 'hr ago' },
  'friends.daysAgo': { id: 'hari lalu', en: 'd ago' },
  ...
  'friends.exerciseCompleted': { id: 'olahraga', en: 'exercised' },
  'friends.exerciseFor': { id: 'selama', en: 'for' },
  'friends.exerciseMin': { id: 'mnt', en: 'min' },
  'friends.calorieGoalMet': { id: 'mencapai target kalori', en: 'hit calorie goal' },
  'friends.proteinGoalMet': { id: 'mencapai target protein', en: 'hit protein goal' },
  ...
  'friends.feedDeleted': { id: 'Notifikasi dihapus', en: 'Notification deleted' },
  'friends.feedDeleteFailed': { id: 'Gagal menghapus notifikasi', en: 'Failed to delete notification' },
  'friends.reject': { id: 'Tolak', en: 'Reject' },
