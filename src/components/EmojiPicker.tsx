...
const EMOJI_CATEGORIES = [
  { nameKey: 'emoji.fitness', emojis: ['💪', '🏃', '🚴', '🏋️', '🧘', '🤸', '⛹️', '🏊', '🥊', '🎯', '🏄', '🧗', '🤾', '🏇', '⚽', '🏀', '🏈', '🎾', '🏐', '🏓', '🏸', '⛷️', '🛹', '🤿', '🚣', '⚾', '🥋', '🤼', '🏌️', '🎿', '🛷', '⛸️', '🥏', '🤺'] },
  { nameKey: 'emoji.health', emojis: ['💤', '💧', '🧠', '❤️', '🫁', '🦷', '💊', '🩺', '🌡️', '🧬', '🩸', '🫀', '🦴', '👁️', '👂', '🦶', '🤧', '😷', '🩹', '🧴', '🧼', '🪥', '🛁', '🚿', '😴', '🥱', '🩻', '💉', '🧪'] },
  { nameKey: 'emoji.food', emojis: ['🥗', '🍎', '🥦', '🍳', '🥤', '☕', '🍵', '🫖', '🥛', '🍌', '🍇', '🍊', '🍋', '🍉', '🍓', '🫐', '🍑', '🥭', '🍍', '🥥', '🥑', '🍆', '🥕', '🌽', '🥒', '🥬', '🫑', '🧄', '🧅', '🍄', '🥜', '🍞', '🥚', '🧀', '🥩', '🍗', '🍖', '🌮', '🍕', '🍜', '🍲', '🥘', '🍱', '🍙', '🍚', '🥮', '🧁', '🍰', '🍫', '🍿'] },
  { nameKey: 'emoji.mind', emojis: ['📖', '✍️', '🎵', '🧩', '🎨', '📝', '🙏', '😌', '🌅', '🌙', '🎹', '🎸', '🎺', '🥁', '🎭', '🎬', '📷', '🎮', '♟️', '🧶', '🪡', '🖌️', '✏️', '📓', '🔮', '🕯️', '🧘‍♀️', '🧘‍♂️', '🪷', '☮️', '🫧', '💭', '💡', '🌈'] },
  { nameKey: 'emoji.productivity', emojis: ['⭐', '🚀', '💻', '📚', '🗂️', '⏰', '📧', '🔔', '✅', '🏆', '📊', '📈', '🗓️', '📋', '🎒', '💼', '🖥️', '⌨️', '🖱️', '📱', '⏳', '🔑', '🔒', '🛠️', '⚙️', '🧰', '📌', '🏅', '🥇', '🥈', '🎖️', '💎', '🔥', '⚡'] },
  { nameKey: 'emoji.social', emojis: ['👋', '🤝', '💬', '📞', '👨‍👩‍👧', '❤️‍🔥', '🎉', '🎂', '📸', '🌍', '🥳', '🎊', '🎁', '🎈', '💌', '💕', '👫', '👭', '👬', '🫂', '🤗', '😊', '😂', '🥰', '😎', '🤩', '👏', '🙌', '✌️', '🤟', '👍', '🫶', '💝', '🎆'] },
  { nameKey: 'emoji.nature', emojis: ['🌳', '🌿', '🌸', '☀️', '🌊', '🐕', '🐈', '🦅', '🌻', '🍃', '🌺', '🌹', '🌷', '💐', '🌾', '🍀', '🍁', '🍂', '🌴', '🎋', '🌵', '🐶', '🐱', '🐰', '🐻', '🦊', '🐼', '🐨', '🦁', '🐯', '🐸', '🦋', '🐝', '🐞', '🌎', '🏔️', '🏖️', '⛰️', '🌄', '🌠', '🌤️', '🌧️'] },
];
